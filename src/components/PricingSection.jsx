  ...
  return (
    <div className="mb-[120px]">
      <div className="text-center">
        ...
        <p className="text-[#627382] text-[16px] mb-3">
      ...
      <div className="flex flex-col justify-center items-center md:flex-row gap-2">
        <div className="card w-96 bg-while shadow-sm text-black">
          <div className="card-body">
            ...
            <div className="mt-6">
              <button className="btn btn-primary btn-block">Get Stated For Free</button>
            </div>
          </div>
        </div>
        <div className="card w-96 bg-[#4F39F6] shadow-sm text-white">
          <div className="card-body">
